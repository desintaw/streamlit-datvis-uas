...
import matplotlib as mpl  # DITAMBAHKAN
...
# =========================
# KONFIGURASI HALAMAN (SATU-SATUNYA DI SINI)
# =========================
st.set_page_config(
...
mpl.rcParams.update({
    "figure.figsize": (6 * VIS_SCALE, 3 * VIS_SCALE),  # DIKECILKAN
    "axes.titlesize": 10 * VIS_SCALE,
    "axes.labelsize": 9 * VIS_SCALE,
    "xtick.labelsize": 8 * VIS_SCALE,
    "ytick.labelsize": 8 * VIS_SCALE,
    "legend.fontsize": 8 * VIS_SCALE,
    "font.size": 9 * VIS_SCALE,
    "lines.linewidth": 1.2 * VIS_SCALE,
    "lines.markersize": 5 * VIS_SCALE,
})

sns.set_context(
    "notebook",  # DIUBAH: dari "paper" ke "notebook"
...
# =========================
# SIDEBAR - DIPERBAIKI TIDAK ADA DUPLIKASI
# =========================
...
page_options = [
    ...
    "☁️ Word Cloud Protein",
    "📈 Scatter Plot"
]
page = st.sidebar.radio("Pilih Halaman:", page_options)

# =========================
# 1. OVERVIEW DATA - DENGAN UKURAN LEBIH KECIL
# =========================
if page == "📊 Overview Data":
    st.header("📊 Overview Data")

    # Gunakan container untuk kontrol ukuran
    with st.container():
        ...
        with tab3:
            ...
            with chart_col:
                # GRAFIK LEBIH KECIL dengan use_container_width=False
                ...
                # KUNCI: use_container_width=False
            ...
            selected_numeric = st.selectbox(
                "Pilih kolom numerik:", numeric_cols, key="dist_numeric"
            )
...
# =========================
    ...
    with st.container():
        ...
        if text_data.strip():
            # WORLCLOUD LEBIH KECIL dengan use_container_width=False
            fig, ax = plt.subplots(figsize=(4, 2))
            wc = WordCloud(
...
# =========================
    ...
    with st.container():
        ...
        # Plot perbandingan - LEBIH KECIL dengan use_container_width=False
        fig, ax = plt.subplots(figsize=(4, 2))
...
# =========================
elif page == "☁️ Word Cloud Protein":
    st.header("☁️ Word Cloud Berdasarkan Level Protein")
