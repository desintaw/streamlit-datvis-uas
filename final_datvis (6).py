...
# =========================
# 1. OVERVIEW DATA - DIPERBAIKI (tanpa scroll horizontal)
# =========================
if page == "Overview Data":
    ...
    with col1:
        ...
        # Tampilkan data tanpa index dan dengan width penuh
        st.dataframe(
            df.head(10),
            use_container_width=True,
            height=320,
            hide_index=True  # Sembunyikan index
        )

    with col2:
        st.subheader("Statistik Deskriptif")
        # Tampilkan statistik deskriptif tanpa index
        st.dataframe(
            df.describe(),
            use_container_width=True,
            height=320,
    ...
    # Baris kedua untuk chart dan info
    ...
    with col4:
        ...
        # Missing values dengan format yang lebih compact
        ...
        missing_filtered = missing_data[missing_data['Missing'] > 0]
        ...
        if len(missing_filtered) > 0:
            ...
            st.dataframe(
                missing_filtered,
                use_container_width=True,
                height=min(200, len(missing_filtered) * 35),
                hide_index=True
            )
        else:
...
# =========================
    ...
    with tab1:
        ...
        fig, axes = plt.subplots(2, 2, figsize=(10, 6))  # Diperkecil
        nutrients = [
            ('Protein_g', 'Protein (g)'),
            ('Fat_g', 'Lemak (g)'),
            ('Sugar_g', 'Gula (g)'),
    ...
    with tab2:
        ...
        fig, ax = plt.subplots(figsize=(8, 4))  # Diperkecil
    ...
    with tab3:
        ...
        fig, ax = plt.subplots(figsize=(8, 6))  # Diperkecil
    ...
    with tab4:
        fig, ax = plt.subplots(figsize=(7, 3))  # Diperkecil
...
# =========================
# 3. ANALISIS TEKS - DIPERBAIKI (gambar diperkecil, TF-IDF tanpa visual)
# =========================
    ...
    with tab1:
        ...
        if text_data.strip():
            fig, ax = plt.subplots(figsize=(6, 3))  # Diperkecil
            wc = WordCloud(
    ...
    with tab2:
        ...
        # Tampilkan tabel tanpa visualisasi TF-IDF
...
# =========================
# 5. ANALISIS MULTI-DIMENSI - DIPERBAIKI (gambar diperkecil)
# =========================
    ...
    with tab1:
        ...
        fig, ax = plt.subplots(figsize=(7, 4))  # Diperkecil
        colors = {'Sehat': 'green', 'Cukup Sehat': 'orange', 'Kurang Sehat': 'red'}
    ...
    with tab2:
        ...
        fig, ax = plt.subplots(figsize=(7, 5), subplot_kw=dict(projection='polar'))  # Diperkecil
