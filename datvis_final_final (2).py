        ...
        with cols[idx % 2]:
            ...
            if len(quartile_texts) > 0:
                ...
                if len(all_text.strip()) > 0:
                    # UKURAN DIUBAH: menjadi setengah dari sebelumnya
                    fig, ax = plt.subplots(figsize=(2, 1.5))
                    wc = WordCloud(
                        width=150,  # Setengah dari 300
                        height=100,  # Setengah dari 200
                        background_color='white',
                        colormap='viridis',
                        max_words=20,  # Diperkecil
                        contour_width=1,
                    ...
                    ax.set_title(f'Protein: {quartile}\n({len(quartile_texts)} makanan)',
                                fontsize=7, fontweight='bold')  # Font lebih kecil
                    ax.axis('off')
                    ...
                    ax.text(0.5, -0.1, f'Rata-rata: {mean_protein:.1f}g',
                           transform=ax.transAxes, ha='center', fontsize=5,  # Font lebih kecil
...
# =========================
    ...
    fig, ax = plt.subplots(figsize=(3.5, 2))  # Setengah dari (7,4)
    ...
    ax.set_title(f'Hubungan {x_axis} dan {y_axis}', fontsize=9, fontweight='bold')  # Font lebih kecil
    ax.set_xlabel(x_axis.replace('_', ' '), fontsize=7)  # Font lebih kecil
    ax.set_ylabel(y_axis.replace('_', ' '), fontsize=7)  # Font lebih kecil
    ax.tick_params(labelsize=6)  # Font lebih kecil
    ax.grid(True, alpha=0.3)

    ax.legend(title='Label Kesehatan', fontsize=6, title_fontsize=7)  # Font lebih kecil
    ...
    with st.expander("📊 Lihat Data Point dengan Nilai Ekstrem", expanded=False):
        col1, col2 = st.columns(2)
