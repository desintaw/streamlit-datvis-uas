...
# =========================
    ...
    with tab2:
        ...
        # DIPERKECIL SETENGAHNYA: dari (5, 3) menjadi (2.5, 1.5)
        fig, ax = plt.subplots(figsize=(2.5, 1.5))
        avg.plot(kind='bar', ax=ax)
        ax.set_title("Perbandingan Gula & Natrium", fontsize=7)
    ...
    with tab5:
        ...
        # DIPERKECIL SETENGAHNYA: dari (7, 5) menjadi (2.5, 1.5)
        fig, ax = plt.subplots(figsize=(2.5, 1.5))
        ax.hist(df_numeric_capped["Energy_kcal"], bins=15, edgecolor='black', alpha=0.7)
        ax.set_title("Distribusi Energi (Data Preprocessing)", fontsize=7)
        ax.set_xlabel("Energi (kcal)", fontsize=6)
        ax.set_ylabel("Frekuensi", fontsize=6)
    ...
    with tab6:
        ...
        ax.set_title("Nilai Maksimum Kandungan Nutrisi", fontsize=7)
        ax.set_ylabel("Nilai", fontsize=6)
        ax.tick_params(axis='x', rotation=45, labelsize=5)
        ax.tick_params(axis='y', labelsize=5)
...
# =========================
    ...
    tab1, tab2, tab3 = st.tabs(["Insight Pola Nutrisi", "Perbandingan Antar Kategori", "Scatter Plot"])
    ...
    with tab2:
        ...
        # DIPERKECIL SETENGAHNYA: dari (4, 2) menjadi (2.5, 1.5)
        fig, ax = plt.subplots(figsize=(2.5, 1.5))
        colors = ['green', 'orange', 'red']
        bars = ax.bar(comparison_df['Kategori'], comparison_df['Rata_rata'], color=colors)

        ax.set_title(f'Perbandingan {selected_nutrient}', fontsize=7)
        ax.set_ylabel(f'Rata-rata {selected_nutrient}', fontsize=6)
        ax.tick_params(labelsize=5)
    ...
    with tab3:
        st.subheader("Scatter Plot Analisis Hubungan Nutrisi")
        ...
        scatter = sns.scatterplot(
            ...
            alpha=0.7,
            s=15,  # diperkecil dari 30
            ax=ax,
            legend='brief'
        )

        ax.set_title(f'Hubungan {x_axis} dan {y_axis}', fontsize=8, pad=5)
        ax.set_xlabel(x_axis.replace('_', ' '), fontsize=6, labelpad=2)
        ax.set_ylabel(y_axis.replace('_', ' '), fontsize=6, labelpad=2)
        ax.tick_params(labelsize=5)
