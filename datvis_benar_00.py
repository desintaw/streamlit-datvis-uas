...
# =========================
elif page == "Visualisasi Tambahan":
    st.header("Visualisasi Tambahan")

    tab1, tab2, tab3 = st.tabs([
        "Distribusi Energi Preprocessing",
        "Nilai Maksimum Nutrisi",
        "Top 10 per Kategori"
    ])
    ...
    with tab1:
        ...
        ax.set_title("Distribusi Energi (Kalori) Makanan (Data Setelah Preprocessing)", fontsize=10)
        ax.set_xlabel("Energi (kcal)", fontsize=8)
    ...
    with tab2:
        ...
        ax.set_title("Nilai Maksimum Kandungan Nutrisi", fontsize=10)
