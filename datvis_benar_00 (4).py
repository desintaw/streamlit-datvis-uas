...
# =========================
    ...
    with tab5:
        ...
        # DIPERKECIL SETENGAHNYA: dari (7, 5) menjadi (3.5, 2.5)
        fig, ax = plt.subplots(figsize=(3.5, 2.5))
        ax.hist(df_numeric_capped["Energy_kcal"], bins=15, edgecolor='black', alpha=0.7)
        ax.set_title("Distribusi Energi (Data Preprocessing)", fontsize=9)
        ax.set_xlabel("Energi (kcal)", fontsize=7)
        ax.set_ylabel("Frekuensi", fontsize=7)
    ...
    with tab6:
        ...
        ax.set_title("Nilai Maksimum Kandungan Nutrisi", fontsize=9)
...
# =========================
    ...
    with tab2:
        ...
        # DIPERKECIL SETENGAHNYA: dari (4, 2) menjadi (2, 1)
