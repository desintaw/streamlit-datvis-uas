...
# =========================
    ...
    ax.set_title(f'Hubungan {x_axis} dan {y_axis}', fontsize=11, fontweight='bold')
    ax.set_xlabel(x_axis.replace('_', ' '), fontsize=9)
    ax.set_ylabel(y_axis.replace('_', ' '), fontsize=9)
    ax.tick_params(labelsize=8)
